      ...
      return Column(
        ...
        children: <Widget>[
          ...
          Components.optionsCard(
            ...
            icon: Icon(Icons.data_object, color: Colors.lightBlueAccent),
            captionMaxLines: 1 + 6 + 6,
          ),
          Components.optionsCard(
            ...
            icon: Icon(Icons.computer, color: Colors.tealAccent),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          flex: 2,
                          child: Components.codingCard('brew install git'),
                        ),
                      ],
                    ),
                  ),
      ...
      return Column(
        ...
        children: [
          ...
          Components.titledCodingCardElevated(
            ...
            Icon(Icons.start, color: Colors.cyanAccent),
          ),
          Components.titledCodingCardElevated(
            Components.titledCodingCard(
              'Clone:',
            ...
            Icon(Icons.start, color: Colors.lime),
          ),
          Card(
            elevation: 10,
            shadowColor: Colors.grey,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Components.horizontalCodingCard(
                    ...
                    codingCard: Components.codingCard('git init'),
                  ),
                  Components.horizontalCodingCard(
                    icon: Icon(Icons.circle_outlined, color: Colors.amber[300]),
                    title: 'copy an existing one: ',
                    codingCard: Components.codingCard('git clone'),
                  ),
                ],
              ),
            ),
