            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Expanded(
                    child: FittedBox(
                      child: Icon(Icons.flag, color: Colors.amber[900]),
                    ),
                  ),
                  Expanded(
                    flex: 20,
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Expanded(
                    child: FittedBox(
                      child: Icon(Icons.rule, color: Colors.green),
                    ),
                  ),
                  Expanded(
                    flex: 20,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Components.optionsCard(
                          title: 'Backup: ',
                          caption:
                              '"git reflog" is your 30-day undo insurance.',
                          icon: Icon(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Components.optionsCard(
                          title: '',
                          caption:
                              'Use "reflog", "reset", and "revert" to restore it.',
                          icon: Icon(
                            Icons.looks_two_rounded,
                            color: Colors.tealAccent,
                          ),
