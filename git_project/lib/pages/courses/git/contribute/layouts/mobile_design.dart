        ...
        children: <Widget>[
          ...
          Components.topicTitledCard(
            ...
            itemsList: [
              Components.optionsCard(
                title: '',
                caption: 'On GitHub, click "Fork" (top-right of any repo).',
          ...
          Components.topicTitledCard(
            ...
            itemsList: [
              Components.optionsCard(
                title: 'Sync Forks: ',
                caption: 'Use "Fetch upstream" on GitHub to stay updated.',
          ...
          Components.titledHyperLink(
            ...
            text2: ' and explore its structure.',
          ),
        ],
      );
    }
    ...
    if (index == 3) {
      return Column(
        ...
        children: [
          ...
          Components.topicTitledCard(
            icon: Icon(Icons.label_rounded, color: Colors.orange),
            title: 'Branch Naming Conventions:',
            itemsList: [
              Components.horizontalCodingCard(
                icon: Icon(Icons.circle_outlined, color: Colors.orangeAccent),
                title: 'specific: ',
              ...
              Components.horizontalCodingCard(
                ...
                codingCard: Components.codingCard('docs/update-install-guide'),
              ),
            ],
          ),
          Components.optionsCard(
        ...
        children: [
          ...
          Components.topicTitledCard(
            ...
            itemsList: [
              Components.optionsCard(
                title: '',
                caption: 'Make changes locally based on reviewer comments.',
                icon: Icon(Icons.looks_one_rounded, color: Colors.lightBlue),
                captionMaxLines: 1 + 6 + 6,
              ),
              Components.titledCodingCardElevated(
        ...
        children: [
          ...
          Components.topicTitledCard(
            ...
            itemsList: [
              ...
              Components.optionsCard(
                title: 'Templates: ',
                caption: 'Standardize with ".github/ISSUE_TEMPLATE.md".',
                icon: Icon(Icons.circle_outlined, color: Colors.amber[600]),
                captionMaxLines: 1 + 6 + 6,
              ),
            ],
    ...
    if (index == 12) {
      return Column(
        ...
        children: [
          ...
          Components.topicTitledCard(
            icon: Icon(Icons.key_rounded, color: Colors.amber),
            title: 'Tools:',
            itemsList: [
              Components.optionsCard(
                title: 'Git Submodules: ',
                caption: 'Embed one repo inside another.',
                icon: Icon(Icons.circle_outlined, color: Colors.amber[300]),
                captionMaxLines: 1 + 6 + 6,
              ),
              Components.titledCodingCardElevated(
                Components.titledCodingCard(
                ...
                Icon(Icons.keyboard_outlined, color: Colors.blue[900]),
              ),
            ],
          ),
          Components.titledHyperLink(
            ...
            linkText: 'TensorFlow models repo',
            title: 'Exercise: ',
            text1: 'Clone the ',
            text2: ' with its submodules.',
          ),
          Components.topicTitledCard(
            ...
            itemsList: [
              ...
              Components.titledHyperLink(
                title: '',
                text1: 'Find a "good first issue" on ',
                linkText: 'up-for-grabs.net',
              ...
              Components.optionsCard(
                title: '',
                caption: 'Follow the project’s guidelines to submit a PR.',
