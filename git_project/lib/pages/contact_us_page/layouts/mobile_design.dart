              ...
              child: Column(
                ...
                children: [
                    ...
                    child: SizedBox(
                      ...
                      child: AspectRatio(
                        ...
                        child: FittedBox(
                          fit: BoxFit.cover,
                          child: Image.asset(
                            'assets/images/VohuCode_Mobile_ContactUsPage_Design.png',
                          ),
                        ),
                      ),
                    ),
                  ...
                  AutoSizeText(
                    ...
                    style: TextStyle(
                      fontSize: 50,
                      color: Color.fromARGB(255, 74, 150, 120),
                  ...
                  Card(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(10),
                      child: Row(
                        // FIX 1: Remove invalid 'spacing' property
                        // FIX 2: Remove unnecessary textBaseline
                        children: <Widget>[
                          Container(
                            width: 60, // Add explicit constraints
                            height: 60,
                            child: FittedBox(
                              fit: BoxFit.contain, // Explicit fit
                              child: Image.asset(
                                'assets/images/icons8-github-120.png',
                              ),
                            ),
                          ),
                          SizedBox(width: 20), // Add spacing manually
                          Expanded(
                            // FIX 3: Remove excessive flex value
                            child: AutoSizeText.rich(
                              TextSpan(
                                children: [
                                  TextSpan(
                                    text: 'https://github.com/VohuCode',
                                    style: TextStyle(
                                      color: Colors.black,
                                      fontSize: 25,
                                  ...
                                  // FIX 4: Remove empty TextSpan
                                ],
                              ),
                              minFontSize: 10,
                              maxLines: 1, // Changed from 3 for URL display
                            ),
                          ),
                        ],
                      ),
